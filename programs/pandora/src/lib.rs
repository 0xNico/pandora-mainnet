...
pub const FEE_WALLET: &str = "DARKLDJ9AtJFX8E9GCdeujfkPjVWUMjxBNm1uqeATiWQ";
pub const FEE_LAMPORTS: u64 = 10_690_000; // 0.01069 SOL
pub const FEE_LAMPORTS_RAFFLE: u64 = 16_900_000; // 0.01690 SOL

declare_id!("FE6d3eupaL74LBpLoe4cJqEn6fzSUrp9AVp75B58SSAc");
